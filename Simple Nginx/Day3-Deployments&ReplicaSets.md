...
Now that we know how the cluster heals itself, let's see how it handles a change to your application. This is exactly what happens when your GitLab CI/CD pipeline pushes a new version.  
...
Because we used a Deployment, Kubernetes keeps a history of your changes (Revisions).
